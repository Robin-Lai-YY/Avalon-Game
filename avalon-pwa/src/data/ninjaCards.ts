 ...
 *  - Spy / Mystic / Blind Assassin / Shinobi / Mirror Monk / Martyr / Mastermind
...
export const NINJA_CARD_DEFS: NinjaCardDef[] = [
  // Spy phase — view a target's house card. 4 cards, priorities 1..4.
  { kind: 'spy', variant: null, priority: 1, name: '情报员 1', text: '指定一名玩家，秘密查看其流派牌。', count: 1 },
  { kind: 'spy', variant: null, priority: 2, name: '情报员 2', text: '指定一名玩家，秘密查看其流派牌。', count: 1 },
  { kind: 'spy', variant: null, priority: 3, name: '情报员 3', text: '指定一名玩家，秘密查看其流派牌。', count: 1 },
  { kind: 'spy', variant: null, priority: 4, name: '情报员 4', text: '指定一名玩家，秘密查看其流派牌。', count: 1 },

  // Mystic phase — view house card + 1 random ninja card. 3 cards.
  { kind: 'mystic', variant: null, priority: 1, name: '灵媒 1', text: '指定一名玩家，秘密查看其流派牌，并随机查看其手中 1 张忍者牌。', count: 1 },
  { kind: 'mystic', variant: null, priority: 2, name: '灵媒 2', text: '指定一名玩家，秘密查看其流派牌，并随机查看其手中 1 张忍者牌。', count: 1 },
  { kind: 'mystic', variant: null, priority: 3, name: '灵媒 3', text: '指定一名玩家，秘密查看其流派牌，并随机查看其手中 1 张忍者牌。', count: 1 },
  ...
  { kind: 'trickster', variant: 'judgement', priority: 6, name: '审判', text: '公开自己的流派牌，然后击杀一名玩家。镜僧与殉道者无法响应此击杀。', count: 1 },

  // Blind Assassin — direct kill, can be countered. 5 cards.
  { kind: 'blind_assassin', variant: null, priority: 1, name: '盲眼刺客 1', text: '指定一名玩家，直接将其暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'blind_assassin', variant: null, priority: 2, name: '盲眼刺客 2', text: '指定一名玩家，直接将其暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'blind_assassin', variant: null, priority: 3, name: '盲眼刺客 3', text: '指定一名玩家，直接将其暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'blind_assassin', variant: null, priority: 4, name: '盲眼刺客 4', text: '指定一名玩家，直接将其暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'blind_assassin', variant: null, priority: 5, name: '盲眼刺客 5', text: '指定一名玩家，直接将其暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },

  // Shinobi — peek then choose to kill. 5 cards.
  { kind: 'shinobi', variant: null, priority: 1, name: '忍者 1', text: '指定一名玩家，秘密查看其流派牌后决定是否暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'shinobi', variant: null, priority: 2, name: '忍者 2', text: '指定一名玩家，秘密查看其流派牌后决定是否暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'shinobi', variant: null, priority: 3, name: '忍者 3', text: '指定一名玩家，秘密查看其流派牌后决定是否暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'shinobi', variant: null, priority: 4, name: '忍者 4', text: '指定一名玩家，秘密查看其流派牌后决定是否暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },
  { kind: 'shinobi', variant: null, priority: 5, name: '忍者 5', text: '指定一名玩家，秘密查看其流派牌后决定是否暗杀（可被镜僧反弹或殉道者代死）。', count: 1 },

  // Reactive cards — held outside phase order, played on assassination triggers.
  { kind: 'mirror_monk', variant: null, priority: 1, name: '镜僧', text: '当你被盲眼刺客或忍者指定为暗杀目标时打出：暗杀反弹至攻击者，你不会死亡。', count: 4 },
  { kind: 'martyr', variant: null, priority: 2, name: '殉道者', text: '当其他玩家被盲眼刺客或忍者暗杀时打出：你代替其死亡，原目标存活。', count: 4 },

  // Mastermind — reveal at end of night; if alive, only this player gets a token this round.
  { kind: 'mastermind', variant: null, priority: 1, name: '幕后黑手 1', text: '夜晚结束时若你仍存活，公开此牌：本回合不再发放任何流派荣誉标记，仅你（与存活的浪人）各获得 1 个荣誉标记。', count: 1 },
  { kind: 'mastermind', variant: null, priority: 2, name: '幕后黑手 2', text: '夜晚结束时若你仍存活，公开此牌：本回合不再发放任何流派荣誉标记，仅你（与存活的浪人）各获得 1 个荣誉标记。', count: 1 },
]
...
/** Reactive window duration. */
export const REACTIVE_WINDOW_MS = 8000
